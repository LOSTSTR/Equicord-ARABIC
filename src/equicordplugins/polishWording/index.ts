...
const settings = definePluginSettings({
    quickDisable: {
        ...
        description: "Quick disable. Stops message editing without needing to restart the client.",
        default: false,
    },
    ...
    fixPunctuationFrequency: {
        ...
        description: "Dot frequency percentage (may annoy some people).",
...
export default definePlugin({
    name: "PolishWording",
    description: "Modifies your messages to make them prettier and better written. Check the settings",
