...
export const settings = definePluginSettings({
    allowlistedChannels: {
        ...
        description: "Comma-separated list of channel IDs to show the plugin install button in"
    },
    notifyIfUpdate: {
        type: OptionType.BOOLEAN,
        description: "Show a Vencord notification if user plugins need an update",
        default: true
    },
    neverNotifyForPlugins: {
        type: OptionType.STRING,
        description: "Don't show update notifications for these plugins (you can still update them from the UserPlugins tab)",
        default: ""
    },
    setGitPath: {
