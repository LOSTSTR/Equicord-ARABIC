...
const settings = definePluginSettings({
    oscilloscope: {
        ...
        description: "Enable the oscilloscope visualizer.",
        default: true,
    },
    spectrograph: {
        type: OptionType.BOOLEAN,
        description: "Enable the spectrograph visualizer.",
        default: true,
    },
    ...
    oscilloscopeColor: {
        ...
        description: "Oscilloscope color (R, G, B or #hex).",
        default: "255, 255, 255",
        onChange: value => validateColor(value, "oscilloscopeColor", "255, 255, 255"),
    },
    spectrographSolidColor: {
        type: OptionType.BOOLEAN,
        description: "Use a solid color for the spectrograph visualizer.",
        default: false,
    },
    spectrographColor: {
        type: OptionType.STRING,
        description: "Spectrograph visualizer color (R, G, B or #hex).",
        default: "33, 150, 243",
        onChange: value => validateColor(value, "spectrographColor", "33, 150, 243"),
    },
    corsProxy: {
        type: OptionType.STRING,
        description: "CORS proxy URL for audio playback. Leave empty to disable the proxy.",
...
export default definePlugin({
    ...
    description: "Adds a spectrograph and oscilloscope visualizer to audio players in attachments",
