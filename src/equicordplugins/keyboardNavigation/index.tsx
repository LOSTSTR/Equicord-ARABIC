...
export const settings = definePluginSettings({
    hotkey: {
        description: "Keyboard shortcut to open the command palette",
    ...
    allowMouseControl: {
        description: "Allow mouse control of the command palette.",
...
export default definePlugin({
    ...
    description: "Allows you to navigate the UI using your keyboard.",
