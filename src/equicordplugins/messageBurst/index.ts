...
const settings = definePluginSettings({
    timePeriod: {
        ...
        description: "Merge period (in seconds)",
        default: 3
    },
    ...
    useSpace: {
        type: OptionType.BOOLEAN,
        description: "Add a space between messages when merging instead of new lines.",
        default: false
    }
});
...
export default definePlugin({
    name: "MessageBurst",
    description: "Merges messages sent within a time period with your previous message if nobody else sent a message before you.",
