...
const settings = definePluginSettings({
    ...
    friendDirectMessagesShowMembers: {
        type: OptionType.BOOLEAN,
        description: "Show the list of other members in the voice channel when receiving a friend join DM notification",
        default: true
    },
    friendDirectMessagesShowMemberCount: {
        type: OptionType.BOOLEAN,
        description: "Show the count of other members in the voice channel when receiving a friend join notification",
        default: false
    },
    friendDirectMessagesSelf: {
        type: OptionType.BOOLEAN,
        description: "Receive notifications in your friends' DMs even if you're in the same voice channel",
        default: false
    },
    ...
    allowedFriends: {
        ...
        description: "List of friend IDs you want to receive join messages from (comma or space separated)",
        default: ""
    },
    ignoredFriends: {
        type: OptionType.STRING,
        description: "List of friend IDs you don't want to receive join messages from (comma or space separated)",
        default: ""
    },
    ignoreBlockedUsers: {
        type: OptionType.BOOLEAN,
        description: "Don't send messages about blocked users joining/leaving/moving voice channels",
        default: true
    },
});
...
export default definePlugin({
    ...
    description: "Receive client-side temporary messages when your friends join voice channels",
