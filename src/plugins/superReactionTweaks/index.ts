...
export const settings = definePluginSettings({
    superReactByDefault: {
        ...
        description: "Makes the reaction picker default to super reactions",
        default: true,
    },
    unlimitedSuperReactionPlaying: {
        type: OptionType.BOOLEAN,
        description: "Remove the limit on playing super reactions simultaneously",
        default: false,
    },

    superReactionPlayingLimit: {
        description: "Maximum number of concurrent super reactions. 0 to disable playback",
