...
export const settings = definePluginSettings({
    toolTip: {
        ...
        description: "Show the member count in the server tooltip",
        default: true,
        restartNeeded: true
    },
    memberList: {
        type: OptionType.BOOLEAN,
        description: "Show the member count in the member list",
        default: true,
        restartNeeded: true
    },
    voiceActivity: {
        type: OptionType.BOOLEAN,
        description: "Show voice activity along with the member count in the member list",
        default: true
    }
});
...
export default definePlugin({
    name: "MemberCount",
    description: "Shows the member count for the server and channel",
