...
const settings = definePluginSettings({
    reactionCount: {
        description: "Number of quick reactions (0-42)",
        type: OptionType.NUMBER,
        default: 5
    },
    frequentEmojis: {
        description: "Use the most frequently used emojis instead of favorites",
        type: OptionType.BOOLEAN,
        restartNeeded: true,
        default: true
    },
    rows: {
        description: "Number of quick reaction rows to display",
    ...
    columns: {
        description: "Number of quick reaction columns to display",
        type: OptionType.SLIDER,
        default: 4,
    ...
    compactMode: {
        description: "Shrink buttons to 75% of their original size while scaling up the inner emoji to 125%. Emojis will be 93.75% of their original size. At least 5 columns recommended",
        type: OptionType.BOOLEAN,
        default: false
    },
    scroll: {
        description: "Enable scrolling in the emoji list",
        type: OptionType.BOOLEAN,
        default: true
    }
});
...
export default definePlugin({
    ...
    description: "Adds more quick reactions",
