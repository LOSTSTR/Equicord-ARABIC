...
export const settings = definePluginSettings({
    notifyOnAutoConnect: {
        description: "Notify when Dev Companion connects automatically.",
        type: OptionType.BOOLEAN,
        default: true
    },
    usePatchedModule: {
        description: "On extract requests, respond with the current patched module (if patched) instead of the original.",
        default: true,
        type: OptionType.BOOLEAN,
    },
    reloadAfterToggle: {
        description: "Reload after receiving a plugin disable/enable command.",
        default: true,
        type: OptionType.BOOLEAN
    }
});
