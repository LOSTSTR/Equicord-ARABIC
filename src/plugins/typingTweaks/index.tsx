...
const settings = definePluginSettings({
    ...
    alternativeFormatting: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Show a more informative message when several users are typing"
    },
    amITyping: {
        type: OptionType.BOOLEAN,
        default: false,
        restartNeeded: true,
        description: "Shows you if others can see you are typing"
    }
});
...
export default definePlugin({
    name: "TypingTweaks",
    description: "Enhances the typing indicator with avatars and names",
