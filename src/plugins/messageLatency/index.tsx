...
export default definePlugin({
    ...
    settings: definePluginSettings({
        latency: {
            ...
            description: "Minimum latency in seconds to show the latency indicator",
            default: 2
        },
        detectDiscordKotlin: {
            type: OptionType.BOOLEAN,
            description: "Detect old Discord clients on Android",
            default: true
        },
        showMillis: {
            type: OptionType.BOOLEAN,
        ...
        ignoreSelf: {
            type: OptionType.BOOLEAN,
            description: "Do not add the indicator to your own messages",
            default: false
        }
    }),
