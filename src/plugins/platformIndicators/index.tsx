...
const platformMap = {
    embedded: t("vencord.platformIndicators.platforms.console"),
    desktop: t("vencord.platformIndicators.platforms.desktop"),
    mobile: t("vencord.platformIndicators.platforms.mobile"),
    web: t("vencord.platformIndicators.platforms.web"),
    vr: t("vencord.platformIndicators.platforms.vr"),
};
