...
const settings = definePluginSettings({
    messages: {
        ...
        default: true,
        description: "Show custom name format in messages.",
    },
    replies: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Show custom name format in replies.",
    },
    mentions: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Show custom name format in mentions.",
    },
    typingIndicator: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Show the first available name in the custom name format in the typing indicator.",
    },
    memberList: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Show the first available name in the member list, DM list, and friends list.",
    },
    profilePopout: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Show the first available name in profile popouts.",
    },
    voiceChannels: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Show the first available name in voice channels.",
    },
    reactions: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Show the first available name in reaction tooltips and the full name in reaction popouts.",
    },
    discriminators: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Append discriminators to bot usernames. Discriminators are no longer used for users but are still used for bots. By default, a bot's username equals its global name, so multiple bots can share the same name. Appending discriminators makes them unique again.",
    },
    hideDefaultAtSign: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "Hide the default \"@\" sign before the name in mentions and replies. Only applies if one of these features is enabled.",
    },
    truncateAllNamesWithStreamerMode: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "Truncate all names and not just usernames in streamer mode.",
    },
    removeDuplicates: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "If any names are duplicates, remove them leaving only unique names.",
    },
    ignoreFonts: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "Use Discord default fonts for non-primary names regardless of the user's custom Nitro font.",
    },
    ignoreGradients: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "For non-primary names, if the role has a gradient and the setting below is set to \"Role+-#\", use the primary color instead of the full gradient; if it has a Nitro effect it is ignored entirely."
    },
    animateGradients: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "For non-primary names, animate if the role has a gradient or Nitro effect. Disabled by \"Ignore Gradients\" and reduced motion.",
    },
    nameSeparator: {
        type: OptionType.STRING,
        description: "The separator used between names. Default is a single space.",
        default: " ",
    },
    friendNameOnlyInDirectMessages: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "Show friend names only in DMs and not in servers.",
    },
    customNameOnlyInDirectMessages: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "Show custom names only in DMs and not in servers.",
    },
    alwaysShowEffects: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "Always show effects as if you are hovering.",
    },
    includedNames: {
        type: OptionType.STRING,
        description: "The display order for usernames, display names, nicknames, friend names, and custom names. Use these placeholders: {user}, {display}, {nick}, {friend}, {custom}. Provide multiple name options as fallbacks if one isn't available by separating with commas: {custom, friend, nick}. Each name can have up to three prefixes and three suffixes.",
        default: "{custom, friend, nick} [{display}] (@{user})",
        isValid: validTemplate,
    },
    customNameColor: {
        type: OptionType.STRING,
        description: "The color used for the custom name you set for the user if it isn't the first name shown. Accepts any valid CSS input. Use \"Role\" to follow the user's highest role colors, Nitro effect colors, or IRCColors color if enabled. Use \"Role+-#\" to adjust brightness by that amount (e.g. \"Role+15\").",
        default: "Role-25",
        isValid: validColor,
    },
    friendNameColor: {
        type: OptionType.STRING,
        description: "The color used for the friend name if it isn't the first name shown. Accepts any valid CSS input. Use \"Role\" to follow the user's highest role colors, Nitro effect colors, or IRCColors color if enabled. Use \"Role+-#\" to adjust brightness by that amount (e.g. \"Role+15\").",
        default: "Role-25",
        isValid: validColor,
    },
    nicknameColor: {
        type: OptionType.STRING,
        description: "The color used for the nickname if it isn't the first name shown. Accepts any valid CSS input. Use \"Role\" to follow the user's highest role colors, Nitro effect colors, or IRCColors color if enabled. Use \"Role+-#\" to adjust brightness by that amount (e.g. \"Role+15\").",
        default: "Role-25",
        isValid: validColor,
    },
    displayNameColor: {
        type: OptionType.STRING,
        description: "The color used for the display name if it isn't the first name shown. Accepts any valid CSS input. Use \"Role\" to follow the user's highest role colors, Nitro effect colors, or IRCColors color if enabled. Use \"Role+-#\" to adjust brightness by that amount (e.g. \"Role+15\").",
        default: "Role-25",
        isValid: validColor,
    },
    usernameColor: {
        type: OptionType.STRING,
        description: "The color used for the username if it isn't the first name shown. Accepts any valid CSS input. Use \"Role\" to follow the user's highest role colors, Nitro effect colors, or IRCColors color if enabled. Use \"Role+-#\" to adjust brightness by that amount (e.g. \"Role+15\").",
        default: "Role-25",
        isValid: validColor,
    },
    triggerNameRerender: {
        type: OptionType.BOOLEAN,
        description: "Trigger name re-render by toggling this setting.",
        default: false,
        hidden: true
    },
});
