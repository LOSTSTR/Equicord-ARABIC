...
export const settings = definePluginSettings({
    sidebar: {
        ...
        description: "Show folder servers in a dedicated sidebar",
        restartNeeded: true,
        default: true
    },
    sidebarAnim: {
        type: OptionType.BOOLEAN,
        description: "Animate the folder sidebar opening",
        default: true
    },
    closeAllFolders: {
        type: OptionType.BOOLEAN,
        description: "Close all folders when selecting a server not in any folder",
        default: false
    },
    closeAllHomeButton: {
        type: OptionType.BOOLEAN,
        description: "Close all folders when pressing the home button",
        restartNeeded: true,
        default: false
    },
    closeOthers: {
    ...
    closeServerFolder: {
        type: OptionType.BOOLEAN,
        description: "Close the folder when selecting a server inside it",
        default: false,
    },
    forceOpen: {
        type: OptionType.BOOLEAN,
        description: "Force the folder to open when navigating to a server inside it",
        default: false
    },
    enableNestedFolders: {
        type: OptionType.BOOLEAN,
        description: "Allow nesting folders inside each other via drag and drop.",
        default: true
    },
    keepIcons: {
        type: OptionType.BOOLEAN,
        description: "Keep showing server icons in the main server list when the BetterFolders sidebar is open",
        restartNeeded: true,
        default: false
    },
    showFolderIcon: {
...
export default definePlugin({
    name: "BetterFolders",
    description: "Adds enhancements to server folders",
