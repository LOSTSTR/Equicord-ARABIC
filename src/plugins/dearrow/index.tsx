...
const settings = definePluginSettings({
    hideButton: {
        description: "Hide the Dearrow button from YouTube embeds",
        type: OptionType.BOOLEAN,
        default: false,
        restartNeeded: true
    },
    replaceElements: {
        description: "Choose which elements to replace in the embed",
    ...
    dearrowByDefault: {
        description: "Apply DeArrow to videos automatically",
        type: OptionType.BOOLEAN,
        default: true,
        restartNeeded: false
    }
