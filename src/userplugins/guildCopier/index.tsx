...
const settings = definePluginSettings({
    copyRoles: {
        ...
        description: "Copy roles from the source server",
        default: true,
    },
    copyChannels: {
        type: OptionType.BOOLEAN,
        description: "Copy channels and categories from the source server",
        default: true,
    },
    copyEmojis: {
        type: OptionType.BOOLEAN,
        description: "Copy emojis from the source server",
        default: true,
    },
    copyStickers: {
        type: OptionType.BOOLEAN,
        description: "Copy stickers from the source server",
        default: true,
    },
    copyBots: {
        type: OptionType.BOOLEAN,
        description: "Create a #bots-list channel with invite links for all bots in the source server",
        default: true,
    },
    emojiCount: {
