...
async function doSyncV2(uploads: SyncRequest["uploads"], clientManifest: ManifestEntry[]): Promise<SyncResponse | null> {
    ...
    if (!res.ok) {
        ...
        showNotification({
            title: t("vencord.cloud.settings.header"),
            body: t("vencord.cloud.settings.apiReject", { e: res.status }),
            color: "var(--red-360)",
        });
        return null;
    }
...
async function putV2(manual?: boolean) {
    ...
    if (manual) {
        showNotification({
            title: t("vencord.cloud.settings.header"),
            body: hadDownloads
                ? t("vencord.cloud.settings.updated")
                : t("vencord.cloud.settings.updatedRemote"),
            color: "var(--green-360)",
    ...
    if (shouldNotify)
        showNotification({
            ...
            body: settingsChanged
                ? t("vencord.cloud.settings.updated")
                : t("vencord.cloud.settings.syncedCloud"),
            color: "var(--green-360)",
...
async function deleteV2() {
    ...
    if (!manifestRes.ok) {
        showNotification({
            title: t("vencord.cloud.settings.header"),
            body: t("vencord.cloud.settings.manifest", { e: manifestRes.status }),
            color: "var(--red-360)",
        });
        return;
    }
...
async function putV1(manual?: boolean) {
    ...
    if (!res.ok) {
        ...
        showNotification({
            title: t("vencord.cloud.settings.header"),
            body: t("vencord.cloud.settings.faildToSync", { e: res.status }),
            color: "var(--red-360)",
        });
        return;
    }
    ...
    if (manual) {
        showNotification({
            title: t("vencord.cloud.settings.header"),
            body: t("vencord.cloud.settings.success"),
            noPersist: true,
        });
    }
...
async function getV1(shouldNotify: boolean, force: boolean) {
    ...
    if (res.status === 404) {
        ...
        if (shouldNotify)
            showNotification({
                title: t("vencord.cloud.settings.header"),
                body: t("vencord.cloud.settings.noSettings"),
                noPersist: true,
            });
        return false;
    }
    ...
    if (!force && written < localWritten) {
        if (shouldNotify)
            showNotification({
                title: t("vencord.cloud.settings.header"),
                body: t("vencord.cloud.settings.newerThanCloud"),
                noPersist: true,
            });
        return false;
    }
...
async function deleteV1() {
    ...
    if (!res.ok) {
        ...
        showNotification({
            title: t("vencord.cloud.settings.header"),
            body: t("vencord.cloud.settings.apiDelete", { e: res.status }),
            color: "var(--red-360)",
        });
        return;
    }
...
export async function putCloudSettings(manual?: boolean) {
    try {
        ...
        showNotification({
            title: t("vencord.cloud.settings.header"),
            body: t("vencord.cloud.settings.apiReject", { e: e.toString() }),
            color: "var(--red-360)",
        });
    }
}
...
export async function deleteCloudSettings() {
    try {
        ...
        showNotification({
            title: t("vencord.cloud.settings.header"),
            body: t("vencord.cloud.settings.failedToDelete", { e: e.toString() }),
            color: "var(--red-360)",
        });
    }
}
...
export async function eraseAllCloudData() {
    ...
    if (!res.ok) {
        ...
        showNotification({
            ...
            body: t("vencord.cloud.settings.apiEraseAll", { e: res.status }),
            color: "var(--red-360)"
        });
        return;
    }
    ...
    showNotification({
        title: t("vencord.cloud.integrations.header"),
        body: t("vencord.cloud.settings.erased"),
        color: "var(--green-360)"
    });
}
